        ...
        <div class="panel-body">
            ...
            {{
                Form::open([
                    ...
                    'method' => 'DELETE',
                    'onsubmit' => 'return confirmDelete("' . trans('messages.confirm.confirm_delete', ['item' => 'account']) . '")'
                ])
            }}
                <i>{{ trans('admins/names.label.label_delete', ['item' => 'user']) }}</i>
                {{
                    Form::button('<span class="glyphicon glyphicon-trash"></span> ' . trans('names.button.button_delete'),
